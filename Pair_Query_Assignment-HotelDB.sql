...
SELECT 
    h1.HotelID AS Hotel1_ID,
    h1.HotelName AS Hotel1_Name,
    h2.HotelID AS Hotel2_ID,
    h2.HotelName AS Hotel2_Name,
    h1.Location
FROM Hotels h1
JOIN Hotels h2
    ON h1.Location = h2.Location
   AND h1.HotelID < h2.HotelID   -- avoids duplicate/reverse pairs and self-pairing
ORDER BY h1.Location, h1.HotelName, h2.HotelName;
...
ON h1.ContactNumber = h2.ContactNumber
   AND h1.HotelID < h2.HotelID   -- avoids duplicate/reverse pairs and self-pairing
ORDER BY h1.ContactNumber, h1.HotelName, h2.HotelName;
...
from Hotels h1
JOIN Hotels h2
ON h1.PricePerNight = h2.PricePerNight 
and h1.HOtelID < h2.HotelID               -- avoid duplicates and self-matches
ORDER BY h1.PricePerNight;
...
JOIN Hotels h2
   ...
   AND h1.HotelID < h2.HotelID   -- avoid duplicates and self-match
ORDER BY h1.Amenities, h1.CheckInTime;
...
FROM Hotels h1
JOIN Hotels h2
    ON h1.NumRooms = h2.NumRooms
   AND h1.HotelID < h2.HotelID  -- avoid duplicates & self-match
ORDER BY h1.NumRooms;
...
JOIN Hotels h2
   ...
   AND h1.HotelID < h2.HotelID   -- avoid duplicates & self-pairing
ORDER BY h1.CheckOutTime;
...
JOIN Hotels h2
    ON h1.Amenities = h2.Amenities
   AND h1.HotelID < h2.HotelID   -- avoid duplicates/self matches
ORDER BY h1.Amenities, h1.HotelName, h2.HotelName;
